...

{
    ...
    public void UpdateBatteryForSmartwatches()
    {
        ...
        Smartwatches watch = new Smartwatches(4, "Sw22", false, 70);
    ...
    public void UpdateOperatingSystemForComputers()
    {
        ...
        PersonalComputer currentComputer = new PersonalComputer(2, "PC", false, "Windows");
    ...
    {
        var deviceManager = new DeviceManager("input7.txt");
        EmbeddedDevices device = new EmbeddedDevices(1, "Embedded Device", false, "123.123.123.123", "MD Ltd. consist");
        deviceManager.AddDevice(device);
    ...
    public void UpdateTurnOn()
    {
        ...
        Smartwatches watch = new Smartwatches(2, "Sw22", false, 100);
        deviceManager.AddDevice(watch);
        deviceManager.TurnOnDevice(2);
    ...
    public void UpdateTurnOff()
    {
        ...
        Smartwatches watch = new Smartwatches(2, "Sw22", true, 80);
        deviceManager.AddDevice(watch);
        deviceManager.TurnOffDevice(2);
    ...
    public void TurnOnPcWithoutAnOs()
    {
        ...
        PersonalComputer currentComputer = new PersonalComputer(4, "PC", false, "");
        deviceManager.AddDevice(currentComputer);
        Assert.Throws<EmptySystemException>(() => deviceManager.TurnOnDevice(4));
    }
    
    [Fact]
    public void CheckSaveToFileWorksCorrectly()
    {
        string testFilePath = "input14.txt";
    ...
    {
        string testFilePath = "input17.txt";
        var deviceManager = new DeviceManager(testFilePath);
        var device = new Smartwatches(3, "Apple Watch", false, 40);
    
        deviceManager.AddDevice(device);
        deviceManager.TurnOnDevice(3);
